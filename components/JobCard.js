    ...
    `}>
      <div className="flex items-center job-info">
        <img
          ...
          alt={job.company}
          title={job.company}
          className="w-14 h-14 md:w-16 md:h-16 mr-4 job-image"
        />
      ...
      <div className="lg:hidden sm:block pt-3 md:pb-3">
        <hr className="divider border border-blacks " />
      </div>
      <div className="flex flex-wrap items-center mt-4 md:mt-0">
        <span
          ...
          className="
            ...
            rounded-md
            cursor-pointer
            hover:bg-desaturated-dark-cyan
            hover:text-white
            transition-all
            duration-300
          "
